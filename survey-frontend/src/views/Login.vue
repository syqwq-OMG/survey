      ...
      <el-tabs v-model="activeTab">
        ...
        <el-tab-pane label="注册" name="register">
          <el-form :model="regForm" :rules="rules" ref="regFormRef" label-width="0">
            <el-form-item prop="username">
              <el-input v-model="regForm.username" placeholder="设置用户名 (至少3位)" prefix-icon="User" />
            </el-form-item>
            <el-form-item prop="password">
              <el-input v-model="regForm.password" type="password" placeholder="设置密码 (至少6位)" prefix-icon="Lock" show-password />
            </el-form-item>
